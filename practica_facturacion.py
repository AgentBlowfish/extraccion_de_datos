...
print(filtro2)
filtro2.to_csv("practica_facturacion-2.csv")

filtro3=df[df["FECHA_ENT"] == '2022-28-2']
print(filtro3)
filtro3.to_csv("practica_facturacion-3.csv")

filtro4=df[(df["CAN_TOT"] < 5951.7)| (df["STATUS"] == "E")]
print(filtro4)
filtro4.to_csv("practica_facturacion-4.csv")

filtro5 = df.iloc[ : , [0, 6, 7,9]]  
print(filtro5)
filtro5.to_csv("practica_facturacion-5.csv")

filtro6 = df.iloc[7001:7099, :  ] 
print(filtro6)
filtro6.to_csv("practica_facturacion-6.csv")
...
print(filtro7)
filtro7.to_csv("practica_facturacion-7.csv")
